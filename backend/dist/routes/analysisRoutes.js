...
const buildAnalysisResult = (file, buffer) => {
...
router.post("/scan", upload.single("file"), async (req, res) => {
    ...
    try {
        ...
        const buffer = fs_1.default.readFileSync(uploadedPath);
        ...
        if (uploadedPath && fs_1.default.existsSync(uploadedPath)) {
            fs_1.default.unlink(uploadedPath, () => undefined);
        }
    }
});
